    ...
    def test_requires_ten_digit_phone_number(self):
        ...
        with app.app_context():
            with pytest.raises(ValueError):
                ...
                author2 = Author(name='Jane Author', phone_number='12345678901')
...
class TestPost:
    ...
    def test_content_length(self):
        ...
        with app.app_context():
            content_string = "This is content" * 3  # At least 450 characters
            with pytest.raises(ValueError):
    ...
    def test_summary_length(self):
        ...
        with app.app_context():
            content_string = "This is content" * 150
            summary_string = "T" * 251  # Ensure summary is 251 characters long
            with pytest.raises(ValueError):
    ...
    def test_clickbait(self):
        ...
        with app.app_context():
            content_string = "This is content" * 150
            with pytest.raises(ValueError):
                post = Post(title='10 ways to create the ultimate clickbait', content=content_string, category='Fiction')
                db.session.add(post)
                db.session.commit()
